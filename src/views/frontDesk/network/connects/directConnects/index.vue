...
import API from "@/api/network/directConnects";
...
<template>
    ...
    >
        ...
        <template #id="{row}">
            <a-tooltip placement="topLeft">
                <template #title>             
                    <a-typography-paragraph :copyable="{ tooltip: false}" class="tooltip-text">{{ row.direct_connects_id }}</a-typography-paragraph>
                </template>
    ...
    <ops-sub-page
        ...
        :title="subPageRow?.direct_connects_id"
        :basic-config="{
