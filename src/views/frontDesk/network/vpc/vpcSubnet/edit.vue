...
const {putVpcSubnetEdit, getVpcSubnetList } = vpcApi;
...
let {
    ...
    formDataInit,
    editSubmit,
} = opsFormInit({formRef, editTitleLayer, formType, sid, emits, editApi: putVpcSubnetEdit, oneDataApi: getVpcSubnetList, customSubmitData, customEditData});
