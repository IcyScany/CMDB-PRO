...
const {putVpcEdit, getVpcList } = vpcApi;
...
let {
    ...
    formDataInit,
    editSubmit,
} = opsFormInit({formRef, editTitleLayer, formType, sid,emits, editApi: putVpcEdit, oneDataApi: getVpcList, customSubmitData, customEditData});
