...
const {postAddDeploymentTarget, putDeploymentTargetEdit, getDeploymentTargetDetail } = mobileAppApi;
...
let {
    ...
    formDataInit,
    editSubmit,
} = opsFormInit({formRef, editTitleLayer, formType, sid,emits,addApi: postAddDeploymentTarget, editApi: putDeploymentTargetEdit, oneDataApi: getDeploymentTargetDetail , customSubmitData, customEditData});
...
<template>
    <ops-form-container
        :title="`部署目标${formType === $CONFIG.FORM_TYPE.ADD_TYPE ? '新增': '编辑'}`"
        :open="open"
