...
const { postUserGroupAdd } = userGroupManageApi;
...
let {
    ...
    formDataInit,
    editSubmit,
} = opsFormInit({formRef, editTitleLayer, formType, sid,emits, addApi: postUserGroupAdd,  customSubmitData, customEditData});
...
<template>
    <ops-form-container
        :title="`用户组${formType === $CONFIG.FORM_TYPE.ADD_TYPE ? '新增': '编辑'}`"
        :open="open"
