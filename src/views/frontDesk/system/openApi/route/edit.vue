...
const { putUserEdit, getUserDetail, postRouteAdd } = API;
...
const {
    ...
    formDataInit,
    editSubmit,
} = opsFormInit({formRef, editTitleLayer, formType, sid, emits, addApi: postRouteAdd, editApi: putUserEdit, oneDataApi: getUserDetail, customSubmitData, customEditData});
