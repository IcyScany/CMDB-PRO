...
const {
    ...
    formDataInit,
    editSubmit,
} = opsFormInit({formRef, editTitleLayer: TITLE_LAYER, formType, sid, emits, oneDataApi: API.getAppDetail, editApi: API.putAppEdit, customSubmitData, customEditData});
...
<template>
    <ops-form-container
        :title="`应用${formType === $CONFIG.FORM_TYPE.ADD_TYPE ? '新增': '编辑'}`"
        :open="open"
