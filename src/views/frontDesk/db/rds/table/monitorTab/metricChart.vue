...
const renderChart = () => {
    ...
    const unit = rdsMetrics[props.metricName]?.unit || state.chartData.unit || '';
    const label = rdsMetrics[props.metricName]?.label || props.metricName;
            ...
            // 圆圈问号图标
            {
                ...
                children: [
                    ...
                    // 问号
                    {
                        ...
                        tooltip: {
                            show: true,
                            formatter: rdsMetrics[props.metricName]?.tooltip,
                            backgroundColor: '#fff',
                            borderColor: '#e8e8e8',
                            borderWidth: 1,
                            textStyle: {
