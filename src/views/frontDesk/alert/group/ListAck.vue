...
let {
    ...
    formDataInit,
    editSubmit,
} = opsFormInit({formRef, editTitleLayer, formType, sid,emits , editApi: putAck,  customSubmitData, customEditData});
...
<template>
    <ops-form-container
        :title="`${$route.meta.title} - 告警 ${formType === $CONFIG.FORM_TYPE.ADD_TYPE ? '新增': 'ACK'}`"
        :open="open"
