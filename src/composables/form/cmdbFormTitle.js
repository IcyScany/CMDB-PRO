    ...
    const generateCmdbFormTitle = (titles = []) => {
        for (let i in titles) {
            ...
            if (pageDataSource && pageDataSource?.data_source) {
                ...
                else if (pageDataSource?.data_origin &&  pageDataSource?.data_source === 'method') {
