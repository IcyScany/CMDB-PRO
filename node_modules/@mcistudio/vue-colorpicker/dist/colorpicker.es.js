import { ref, reactive, onMounted, watch, nextTick, openBlock, createElementBlock, createElementVNode, normalizeClass, withModifiers, normalizeStyle, withDirectives, Fragment, renderList, toDisplayString, vShow, pushScopeId, popScopeId } from "vue";
const Utils = {
  hsb2rgb(hsb) {
    var rgb = {};
...
const ColorPicker_vue_vue_type_style_index_0_scoped_4e0790ec_lang = "";
...
const _withScopeId = (n) => (pushScopeId("data-v-4e0790ec"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  onselectstart: "return false",
  style: { "position": "relative" }
};
const _hoisted_2 = ["onContextmenu"];
const _hoisted_3 = ["onClick", "onMousedown"];
const _hoisted_4 = ["onClick"];
const _hoisted_5 = { style: { "font-size": "10px", "width": "32px", "padding-left": "8px", "user-select": "none" } };
const _hoisted_6 = { class: "palette-wrapper" };
const _hoisted_7 = ["onClick"];
const _hoisted_8 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "white" }, null, -1));
const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "black" }, null, -1));
const _hoisted_10 = { class: "huebar-wrapper" };
const _hoisted_11 = { class: "bar-wrapper" };
const _hoisted_12 = ["onClick"];
const _hoisted_13 = ["onClick"];
const _hoisted_14 = ["onClick"];
const _hoisted_15 = { class: "preview-wrapper" };
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    if (!["none", "show"].includes(modebar.value))
      modebar.value = "show";
    const activeMode = ref(props.modelValue.mode || "solid");
    if (!["solid", "linear", "radial"].includes(activeMode.value))
        ...
        withDirectives(createElementVNode("div", {
          ...
          createElementVNode("div", {
            ...
            createElementVNode("div", {
              ...
              createElementVNode("div", _hoisted_5, toDisplayString(degree.value) + "°", 1)
            ], 4)
          ], 4),
...
const ColorPicker = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4e0790ec"]]);
