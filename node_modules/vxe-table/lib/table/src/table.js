  ...
  setup(props, context) {
    ...
    tableMethods = {
      ...
      setCheckboxRowKey(keys, checked) {
        ...
        if (!_xeUtils.default.isArray(keys)) {
          keys = [keys];
        }
        const rows = [];
        keys.forEach(rowid => {
    ...
    const renderVN = () => {
      ...
      VxeUILoadingComponent ? (0, _vue.h)(VxeUILoadingComponent, {
        ...
        default: () => callSlot(loadingSlot, {
          $table: $xeTable,
          $grid: $xeGrid,
          loading: currLoading
        })
      } : {}) : loadingSlot ? (0, _vue.h)('div', {
        class: ['vxe-loading--custom-wrapper', {
          'is--visible': currLoading
        }]
      }, callSlot(loadingSlot, {
        $table: $xeTable,
        $grid: $xeGrid,
        loading: currLoading
      })) : renderEmptyElement($xeTable),
    ...
    (0, _vue.watch)(staticColumnFlag, () => {
      handleColumn(_xeUtils.default.clone(reactData.staticColumns));
    });
